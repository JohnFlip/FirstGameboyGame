;Used from: http://cratel.wichita.edu/cratel/ECE238Spr08/software
...
;Init the window added: 4/17/14
;If this was done when background was initilialized, it added the window too soon and gave me a blank screen.
